...
class User(SQLModel, table=True):
    ...
    password: str
    role: str = "customer"  #Default role is "customer", can be "admin" as well

    # This relationship is named "reviews"
    reviews: List["Review"] = Relationship(back_populates="user") # Corrected: back_populates now points to "reviews" in the Review model
